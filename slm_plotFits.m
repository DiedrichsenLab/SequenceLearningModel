function slm_plotFits(Dall , what , mORi)

switch mORi
    case 'm'
        mainDir = '/Users/nedakordjazi/Documents/GitHub/SequenceLearningModel/';
        dataDir = '/Users/nedakordjazi/Documents/SeqEye/SeqEye2/analyze/';
    case 'i'
        mainDir = '/Users/nkordjazi/Documents/GitHub/SequenceLearningModel/';
        dataDir = '/Users/nkordjazi/Documents/SeqEye/SeqEye2/analyze/';
end
...
switch what
    case 'noiseFree'
        ...
        AllR = [];
        D45 = slm_NoiselessFitModel('Simulate' , Dall , 'planFunc' , 'arbitrary','NameExt' , 'IPIMTRTHall_H1-5' , 'Horizon' , [1:5],...
            'MsetField' ,MsetField, 'Day' , Day,'noise' , 0,'mORi' , mORi,'includeRT',0);
        D45.Day = [2]*ones(size(D45.MT));
        Day = 1;
        D1 =  slm_NoiselessFitModel('Simulate' , Dall , 'planFunc' , 'arbitrary','NameExt' , 'IPIMTRTHall_H1-5' , 'Horizon' , [1:5],...
            'MsetField' ,MsetField, 'Day' , Day,'noise' , 0,'mORi' , mORi,'includeRT',0);
        D1.Day = ones(size(D1.MT));
        AllR = addstruct(D45 , D1);
        ...
        Fit.Day  = repmat(F.Day, 1,size(F.IPI,2));
        Fit.Day  = reshape(Fit.Day , numel(F.IPI) , 1);
        ...
        T.Day  = reshape(T.Day , numel(F.planFunc) , 1);
